...
import ThemeToggle from '@/components/rrg/ThemeToggle';
    ...
    <div className="min-h-screen bg-black text-white">
      <header className="border-b border-white/10 px-6 py-4 flex justify-between items-center">
        ...
        <nav className="flex gap-6 items-center text-base text-white/80">
          <Link href="/agents" className="hover:text-green-400 transition-colors">
            Agent
          </Link>
          <Link href="/rrg" className="hover:text-green-400 transition-colors">
            Store
          </Link>
          <Link href="/drops" className="hover:text-green-400 transition-colors">
            Drops
          </Link>
          <LoginButton />
        </nav>
      ...
      <footer className="border-t border-white/10 px-6 py-8 mt-24 text-sm text-white/50 font-mono flex justify-between items-center">
        <div className="flex gap-4 items-center">
          ...
          <a href="https://bsky.app/profile/realrealgenuine.bsky.social" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="BlueSky">
          ...
          <a href="https://t.me/realrealgenuine" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Telegram">
          ...
          <a href="https://instagram.com/realrealgenuine" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
