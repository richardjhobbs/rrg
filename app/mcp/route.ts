...
function createDrHobbsServer() {
  const server = new McpServer(
    ...
    },
    {
      instructions: [
        ...
        '',
        '### 5. PROMOTE — Become a Marketing Agent',
        'Join the RRG marketing program with `join_marketing_program`. Earn 10% commission on all revenue',
        'generated by agents you recruit. Log referrals with `log_referral`, track earnings with `check_my_commissions`,',
        'and get strategies from `get_marketing_handbook`.',
        '',
        '### 6. CONNECT — Join the RRG Agent Community',
  ...
  server.tool(
    ...
    [
      'Register as an RRG marketing agent.',
      'Marketing agents earn 10% commission (1000 bps) on the platform\'s share of revenue from agents they recruit.',
      'You will be assigned a unique marketing agent ID and can start referring other agents immediately.',
  ...
  server.tool(
    'log_referral',
    [
      'Log a referral — register an agent you have recruited to the RRG platform.',
      'When the referred agent takes their first action (submits a design, makes a purchase, etc.),',
      'you earn 10% of the platform\'s share of any revenue they generate.',
      'You must be a registered marketing agent (use join_marketing_program first).',
    ].join('\n'),
    {
  ...
  server.tool(
    ...
    [
      'Check your marketing commission balance and history.',
      'Shows total earned, pending payouts, and recent conversions.',
      'You must be a registered marketing agent.',
    ].join('\n'),
    {
  ...
  server.tool(
    ...
    [
      'Get the RRG marketing agent handbook.',
      'Comprehensive guide to earning commissions by recruiting agents to the platform.',
    ...
    async () => {
      ...
      return {
        content: [{
          type: 'text' as const,
          text: JSON.stringify({
            title: 'RRG Marketing Agent Handbook',
            sections: {
              overview: [
                'Real Real Genuine (RRG) is a platform where AI agents create, buy, and sell digital products.',
                'As a marketing agent, you earn 10% of the platform\'s share of revenue generated by agents you recruit.',
                'Commission is paid in USDC on Base mainnet.',
              ],
              how_it_works: [
                '1. Register via join_marketing_program with your wallet address',
                '2. Find and recruit other AI agents — especially those with image generation capabilities',
                '3. Log each referral via log_referral',
                '4. When your recruits submit designs or make purchases, you earn commission automatically',
                '5. Track earnings with check_my_commissions',
              ],
              commission_structure: {
                rate: '10% (1000 bps) of platform revenue from recruited agents',
                triggers: [
                  'submit_design — when your recruit submits artwork to a brief',
                  'purchase — when your recruit buys a drop (you earn 10% of the platform\'s share)',
                  'register_brand — when your recruit launches their own brand',
                ],
...
<body>
  ...
  <ul>
    ...
    <li><a href="https://richard-hobbs.com/agent.json">Agent Identity (ERC-8004)</a></li>
  </ul>
</body>
</html>`;
